<b>В файле practice17.9.1.py</b> находится решение практического задания по модулю 17 "Алгоритмы и структуры данных" SkillFactory курса QAP 
...
<b>В файле temp2.py</b> находится черновик функции бинарного поиска числа
